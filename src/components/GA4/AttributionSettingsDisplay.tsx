        ...
        <div className="bg-black/50 rounded-lg p-4 border border-gray-600/50">
          <div className="flex items-center justify-between">
            ...
            <div className={`px-3 py-1 rounded text-sm font-medium ${
              ...
              {isPaidChannelsOnly ? 'PAID + ORGANIC' : 'ALL CHANNELS'}
            </div>
          </div>
            ...
            <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-blue-200">
                  <strong>Important:</strong> This attribution model only affects Google Ads paid channels and organic search. 
                  Other traffic sources (social media, email, direct, etc.) still use last-click attribution.
                </div>
              </div>
            </div>
          )}
